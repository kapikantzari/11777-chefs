...
parser.add_argument('--root_dir', help="root directory of all data and annotations", default="../data")
...
parser.add_argument('--howto100m_feature_dir', type=str, default="../data/Features")
...
parser.add_argument('--mstcn_cp', type=str, default="epoch-50.pth")
...
if args.enable_wandb:
    wandb.init(project='mstcn_howto100m', entity='chefs')
