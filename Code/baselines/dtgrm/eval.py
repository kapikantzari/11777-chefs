...
def all_eval_scores(list_of_videos, gt_labels, recog_results, bg_class = [97], print_results = False):
    ...
    INPUT:
        ...
        gt_labels and recog_results are list of gt_label or recog_result for that video
    ...
    for vid in list_of_videos:
        ...
        edit += edit_score(recog_content, gt_content, norm=True, bg_class=bg_class)
...
def single_eval_scores(gt_content, recog_content, bg_class = [97], print_results = False):
    ...
    '''
    list_of_videos = [0]
    gt_content, recog_content = gt_content.cpu().numpy(), recog_content.cpu().numpy()
    # gt_content, recog_content = gt_content[0], recog_content[0]

    # gt_labels = {0:gt_content}
    # recog_results = {0:recog_content}
    return all_eval_scores(list_of_videos, gt_content, recog_content, bg_class, print_results)
