...
parser.add_argument('--df_size', type=int, default=3)
...
trainer = Trainer(wandb_run_name, num_stages, num_layers, num_f_maps, features_dim, num_classes, background_class_idx, df_size, visualize_every=visualize_every, filter_background=filter_background)
